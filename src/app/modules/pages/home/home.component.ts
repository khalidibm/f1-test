...
import { ConstructorState } from 'src/app/shared/interfaces/constructor-state.interface';
import {
  ConstructorPayload,
  MRData as ConstructorMrData,
} from 'src/app/shared/interfaces/constructor.interface';
import { DriverState } from 'src/app/shared/interfaces/driver-state.interface';
import {
  DriverPayload,
  MRData as DriverMrData,
} from 'src/app/shared/interfaces/driver.interface';
import { RaceState } from 'src/app/shared/interfaces/race-state.interface';
import { MRData, RacePayload } from 'src/app/shared/interfaces/race.interface';
...
import { selectConstructorData } from 'src/app/shared/selectors/constructor.selector';
import { selectDriverStandingData } from 'src/app/shared/selectors/driver-standing.selector';
import { selectDriverData } from 'src/app/shared/selectors/driver.selectors';
import { selectRaceData } from 'src/app/shared/selectors/race.selectors';
import { SeasonHelperService } from 'src/app/shared/services/season-helper.service';
